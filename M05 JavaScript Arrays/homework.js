...
function incrementarPorUno(array) {
   ...
   // Tu código:
     var otro = array.map(function(elem){
      elem = elem + 1;
      return elem;
   });
    return otro;
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
    total = arrayOfNums.reduce(function(acum, elem){
      acum = acum + elem;
      return acum;
    });
    return total;
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   total = resultadosTest.reduce(function(acum, elem){
      acum = acum + elem;
      return acum;
    });
...
function mesesDelAño(array) {
   ...
   // Tu código:   for (var i=0)
  var filtrados= array.filter(function (elem){
   return elem === "Marzo" || elem === "Enero" || elem === "Noviembre";})
